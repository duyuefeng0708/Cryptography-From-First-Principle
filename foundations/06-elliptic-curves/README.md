...
The same group theory, a different (and better) group — curves that power modern crypto.
...
- ECDH (X25519) in TLS 1.3: the default key exchange in modern HTTPS connections
- ECDSA in Bitcoin/Ethereum: every transaction is authorized by an ECDSA signature on secp256k1
- Ed25519 in SSH: the recommended signing algorithm for SSH keys
